...
type InsightResponse struct {
	...
	HasAssociatedCategories NullableBool `json:"has_associated_categories,omitempty"`
...
// GetHasAssociatedCategories returns the HasAssociatedCategories field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *InsightResponse) GetHasAssociatedCategories() bool {
	if o == nil || IsNil(o.HasAssociatedCategories.Get()) {
		var ret bool
		return ret
	}
	return *o.HasAssociatedCategories.Get()
}

// GetHasAssociatedCategoriesOk returns a tuple with the HasAssociatedCategories field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *InsightResponse) GetHasAssociatedCategoriesOk() (*bool, bool) {
	...
	return o.HasAssociatedCategories.Get(), o.HasAssociatedCategories.IsSet()
}
...
func (o *InsightResponse) HasHasAssociatedCategories() bool {
	if o != nil && o.HasAssociatedCategories.IsSet() {
		return true
	}
...
// SetHasAssociatedCategories gets a reference to the given NullableBool and assigns it to the HasAssociatedCategories field.
func (o *InsightResponse) SetHasAssociatedCategories(v bool) {
	o.HasAssociatedCategories.Set(&v)
}
// SetHasAssociatedCategoriesNil sets the value for HasAssociatedCategories to be an explicit nil
func (o *InsightResponse) SetHasAssociatedCategoriesNil() {
	o.HasAssociatedCategories.Set(nil)
}
...
func (o *InsightResponse) UnsetHasAssociatedCategories() {
	o.HasAssociatedCategories.Unset()
}
...
func (o InsightResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.HasAssociatedCategories.IsSet() {
		toSerialize["has_associated_categories"] = o.HasAssociatedCategories.Get()
	}
