...
type MicrodepositRequestBody struct {
	MicroDeposit *MicrodepositElements `json:"micro_deposit,omitempty"`
}
...
// SetMicroDeposit gets a reference to the given MicrodepositElements and assigns it to the MicroDeposit field.
