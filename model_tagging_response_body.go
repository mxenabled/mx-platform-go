...
// checks if the TaggingResponseBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaggingResponseBody{}
...
func NewNullableTaggingResponseBody(val *TaggingResponseBody) *NullableTaggingResponseBody {
	return &NullableTaggingResponseBody{value: val, isSet: true}
}
