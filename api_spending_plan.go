...
type ApiReadCurrentSpendingPlanIterationRequest struct {
	ctx context.Context
	ApiService *SpendingPlanAPIService
	userGuid string
	spendingPlanGuid string
...
// Results are paginated. Specify current page.
func (r ApiReadCurrentSpendingPlanIterationRequest) Page(page int32) ApiReadCurrentSpendingPlanIterationRequest {
	r.page = &page
	return r
}

// This specifies the number of records to be returned on each page. Defaults to &#x60;25&#x60;. The valid range is from &#x60;10&#x60; to &#x60;1000&#x60;. If the value exceeds &#x60;1000&#x60;, the default value of &#x60;25&#x60; will be used instead.
func (r ApiReadCurrentSpendingPlanIterationRequest) RecordsPerPage(recordsPerPage int32) ApiReadCurrentSpendingPlanIterationRequest {
	r.recordsPerPage = &recordsPerPage
	return r
}

func (r ApiReadCurrentSpendingPlanIterationRequest) Execute() (*SpendingPlanIterationResponse, *http.Response, error) {
	return r.ApiService.ReadCurrentSpendingPlanIterationExecute(r)
}

/*
ReadCurrentSpendingPlanIteration Read current spending plan iteration
...
Use this endpoint to read the attributes of the current spending plan `iteration`.
 ...
 @param userGuid The unique identifier for a `user`, beginning with the prefix `USR-`.
 @param spendingPlanGuid The unique ID for the `spending_plan`.
 @return ApiReadCurrentSpendingPlanIterationRequest
*/
func (a *SpendingPlanAPIService) ReadCurrentSpendingPlanIteration(ctx context.Context, userGuid string, spendingPlanGuid string) ApiReadCurrentSpendingPlanIterationRequest {
	return ApiReadCurrentSpendingPlanIterationRequest{
		ApiService: a,
		ctx: ctx,
		userGuid: userGuid,
...
func (a *SpendingPlanAPIService) ReadCurrentSpendingPlanIterationExecute(r ApiReadCurrentSpendingPlanIterationRequest) (*SpendingPlanIterationResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SpendingPlanAPIService.ReadCurrentSpendingPlanIteration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/users/{user_guid}/spending_plans/{spending_plan_guid}/iterations/current"
	localVarPath = strings.Replace(localVarPath, "{"+"user_guid"+"}", url.PathEscape(parameterValueToString(r.userGuid, "userGuid")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"spending_plan_guid"+"}", url.PathEscape(parameterValueToString(r.spendingPlanGuid, "spendingPlanGuid")), -1)
