...
`func (o *MemberCreateRequest) GetUseCases() []string`

GetUseCases returns the UseCases field if non-nil, zero value otherwise.

### GetUseCasesOk

`func (o *MemberCreateRequest) GetUseCasesOk() (*[]string, bool)`
...
`func (o *MemberCreateRequest) SetUseCases(v []string)`

SetUseCases sets UseCases field to given value.

### HasUseCases

`func (o *MemberCreateRequest) HasUseCases() bool`
