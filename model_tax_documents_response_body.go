...
// checks if the TaxDocumentsResponseBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxDocumentsResponseBody{}
