...
type MonthlyCashFlowResponse struct {
	...
	EstimatedGoalsContribution NullableFloat32 `json:"estimated_goals_contribution,omitempty"`
...
// GetEstimatedGoalsContribution returns the EstimatedGoalsContribution field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MonthlyCashFlowResponse) GetEstimatedGoalsContribution() float32 {
	if o == nil || IsNil(o.EstimatedGoalsContribution.Get()) {
		var ret float32
		return ret
	}
	return *o.EstimatedGoalsContribution.Get()
}
...
func (o *MonthlyCashFlowResponse) GetEstimatedGoalsContributionOk() (*float32, bool) {
	...
	return o.EstimatedGoalsContribution.Get(), o.EstimatedGoalsContribution.IsSet()
}
...
func (o *MonthlyCashFlowResponse) HasEstimatedGoalsContribution() bool {
	if o != nil && o.EstimatedGoalsContribution.IsSet() {
		return true
	}
...
// SetEstimatedGoalsContribution gets a reference to the given NullableFloat32 and assigns it to the EstimatedGoalsContribution field.
func (o *MonthlyCashFlowResponse) SetEstimatedGoalsContribution(v float32) {
	o.EstimatedGoalsContribution.Set(&v)
}
// SetEstimatedGoalsContributionNil sets the value for EstimatedGoalsContribution to be an explicit nil
func (o *MonthlyCashFlowResponse) SetEstimatedGoalsContributionNil() {
	o.EstimatedGoalsContribution.Set(nil)
}
...
func (o *MonthlyCashFlowResponse) UnsetEstimatedGoalsContribution() {
	o.EstimatedGoalsContribution.Unset()
}
...
func (o MonthlyCashFlowResponse) ToMap() (map[string]interface{}, error) {
	...
	if o.EstimatedGoalsContribution.IsSet() {
		toSerialize["estimated_goals_contribution"] = o.EstimatedGoalsContribution.Get()
	}
