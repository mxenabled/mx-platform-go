...
type RewardResponseBody struct {
	Reward *RewardsResponseBodyRewardsInner `json:"reward,omitempty"`
}
...
// SetReward gets a reference to the given RewardsResponseBodyRewardsInner and assigns it to the Reward field.
